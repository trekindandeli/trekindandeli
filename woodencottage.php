...
<head>
    ...
    <!--Title-->
    <title>Wooden cottage-Trek in Dandeli</title>
    ...
    <div class="wrapper">
            ...
            <div class="container">
                ...
                <nav class="navigation-top clearfix">
                    ...
                    <div class="navigation-top-left">
                        ...
                        <a class="box" href="https://api.whatsapp.com/send?phone= 917349750760&amp;text=Give me further information about  wooden Cottage.">
        ...
        <section class="page">
            ...
            <div class="page-header" style="background-image:url(assets/images/header-1.jpg)">
                <div class="container">
                    <h2 class="title">wooden Cottage</h2>
                ...
                <div class="room-gallery">
                    <div class="container">
                        <div class="owl-slider owl-theme owl-slider-gallery">
                            ...
                            <div class="item" style="background-image:url(assets/images/wooden1.jpg)">
                                <img src="assets/images/room-4.jpg" alt="" />
                            </div>

                            <!-- === slide item === -->

                            <div class="item" style="background-image:url(assets/images/rooms.jpg)">
                            ...
                            <div class="item" style="background-image:url(assets/images/tentstay2.jpg)">
                        ...
                        <div class="booking-wrapper">
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-4">
                                    <a href="https://api.whatsapp.com/send?phone= 917349750760&amp;text=Give me further information about  wooden Cottage." class="btn btn-clean">
                                        Book now
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2">
                                ...
                                <div class="room-block room-aminities">
                                    ...
                                    <p style="font-weight: bold; font-size: 20px; text-align: center;">Night stay in Wooden Cottage with attached Washroom    <br>
                                    </p>
            ...
            <div class="row">
                ...
                <div class="col-sm-12 icons">
                    <ul>
                        ...
                        <li><a href="https://api.whatsapp.com/send?phone= 917349750760&amp;text=Give me further information about wooden Cottage."><i class="fa fa-whatsapp"></i></a></li>
