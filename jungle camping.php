...
<head>
    ...
    <!--Title-->
    <title>Jungle Camping-Trek in Dandeli</title>
    ...
    <div class="wrapper">
                ...
                <nav class="navigation-main clearfix">
                    ...
                    <div class="navigation-block clearfix">
                        ...
                        <ul class="navigation-right">
                            ...
                            <li>
                                <a href="reservation-2.php">Booking <span class="open-dropdown"></span></a>
        ...
        <section class="page">
            ...
            <div class="page-header" style="background-image:url(assets/images/header-1.jpg)">
                <div class="container">
                    <h2 class="title">Jungle Camping</h2>
        ...
        <!-- ========================  Stretcher widget ======================== -->
                ...
                <section class="stretcher-wrapper">
                    ...
                    <ul class="stretcher">
                        ...
                        <li class="stretcher-item" style="background-image:url(assets/images/firecamp.jpg);">
