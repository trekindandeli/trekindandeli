...
<head>
    ...
    <!--Title-->
    <title>student package-Trek in Dandeli</title>
    ...
    <div class="wrapper">
            ...
            <div class="container">
                ...
                <nav class="navigation-top clearfix">
                    ...
                    <div class="navigation-top-left">
                        ...
                        <a class="box" href="https://api.whatsapp.com/send?phone= 917349750760&amp;text=Give me further information about Student Package.">
        ...
        <section class="page">
            ...
            <div class="page-header" style="background-image:url(assets/images/header-1.jpg)">
                <div class="container">
                    <h2 class="title">Student Package</h2>
                        ...
                        <div class="booking-wrapper">
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-4">
                                    <a href="https://api.whatsapp.com/send?phone= 917349750760&amp;text=Give me further information about Student Package." class="btn btn-clean">
                                        Book now
                            ...
                            <div class="col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2">
                                ...
                                <div class="room-block room-aminities">
                                    ...
                                    <p style="font-weight: bold; font-size: 20px; text-align: center;">Night stay in Tent with attached Washroom<br>
                                        (more than 15 People)-1350/-<br>
                                        (less than 15 People)-1500/-
                                    </p>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12 icons">
                            <ul>
                                ...
                                <li><a href="https://api.whatsapp.com/send?phone= 917349750760&amp;text=Give me further information about Student Package."><i class="fa fa-whatsapp"></i></a></li>
