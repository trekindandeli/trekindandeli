...
<head>
    ...
    <!--Title-->
    <title>Group package-Trek in Dandeli</title>
    ...
    <div class="wrapper">
            ...
            <div class="container">
                ...
                <nav class="navigation-top clearfix">
                    ...
                    <div class="navigation-top-left">
                        ...
                        <a class="box" href="https://api.whatsapp.com/send?phone= 917349750760&amp;text=Give me further information about Group package.">
        ...
        <section class="page">
            ...
            <div class="page-header" style="background-image:url(assets/images/header-1.jpg)">
                <div class="container">
                    <h2 class="title">Group Package</h2>
                        ...
                        <div class="booking-wrapper">
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-4">
                                    <a href="https://api.whatsapp.com/send?phone= 917349750760&amp;text=Give me further information about Group package." class="btn btn-clean">
                                        Book now
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12 icons">
                            <ul>
                                ...
                                <li><a href="https://api.whatsapp.com/send?phone= 917349750760&amp;text=Give me further information about Group package."><i class="fa fa-whatsapp"></i></a></li>
