...
<body>
    ...
    <div class="wrapper">
            ...
            <div class="container">
                ...
                <nav class="navigation-top clearfix">
                    ...
                    <div class="navigation-top-left">
                        ...
                        <a class="box" href="https://api.whatsapp.com/send?phone= 917349750760&amp;text=Give me further information about Treck in dandeli with dudhsagar.">
        ...
        <section class="page">
            ...
            <div class="page-header" style="background-image:url(assets/images/1546352.jpg)">
                <div class="container">
                    <h2 class="title">Trek in Dudhsagar</h2>
                ...
                <div class="room-gallery">
                    <div class="container">
                        <div class="owl-slider owl-theme owl-slider-gallery">
                            ...
                            <div class="item" style="background-image:url(assets/images/dudhsagar.jpg)">
                        ...
                        <div class="booking-wrapper">
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-4">
                                    <a href="https://api.whatsapp.com/send?phone= 917349750760&amp;text=Give me further information about Treck in dandeli with dudhsagar." class="btn btn-clean">
                                        Book now
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2">
                                ...
                                <div class="room-block room-aminities">
                                    ...
                                    <p style="font-weight: bold; font-size: 20px; text-align: center;">1 Night stay in tent house with attached Washroom. and dudhsagar visit  <br> 
                                    </p>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12 icons">
                            <ul>
                                ...
                                <li><a href="https://api.whatsapp.com/send?phone= 917349750760&amp;text=Give me further information about Treck in dandeli with dudhsagar."><i class="fa fa-whatsapp"></i></a></li>
