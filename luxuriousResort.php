...
<head>
    ...
    <!--Title-->
    <title>Luxarious Resort-Trek in Dandeli</title>
...
<script type="text/javascript">
    (function () {
        var options = {
            ...
            call: "7349750760", // Call phone number
...
<body>
    ...
    <div class="wrapper">
            ...
            <div class="container">
                ...
                <nav class="navigation-top clearfix">
                    ...
                    <div class="navigation-top-left">
                        ...
                        <a class="box" href="https://api.whatsapp.com/send?phone= 917349750760&amp;text=Give me further information about Luxurious Resort.">
                ...
                <nav class="navigation-main clearfix">
                    ...
                    <div class="navigation-block clearfix">
                        ...
                        <ul class="navigation-right">
                           ...
                           <!--- <li>
                                <a href="reservation-2.html">Booking <span class="open-dropdown"></span></a>
        ...
        <section class="page">
            ...
            <div class="page-header" style="background-image:url(assets/images/1546331.jpg)">
                <div class="container">
                    <h2 class="title">luxurious Resort</h2>
                ...
                <div class="room-gallery">
                    <div class="container">
                        <div class="owl-slider owl-theme owl-slider-gallery">
                            ...
                            <div class="item" style="background-image:url(assets/images/ss2.jpg)">
                        ...
                        <div class="booking-wrapper">
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-4">
                                    <a href="https://api.whatsapp.com/send?phone= 917349750760&amp;text=Give me further information about Luxurious Resort." class="btn btn-clean">
                                        Book now
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2">
                                ...
                                <div class="room-block room-aminities">
                                    ...
                                    <p style="font-weight: bold; font-size: 20px; text-align: center;">Night stay in Tent with attached Washroom    <br>
                                    </p>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12 icons">
                            <ul>
                                ...
                                <li><a href="https://api.whatsapp.com/send?phone= 917349750760&amp;text=Give me further information Luxurious Resort."><i class="fa fa-whatsapp"></i></a></li>
